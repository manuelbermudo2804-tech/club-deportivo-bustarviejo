    ...
    <div className="min-h-[400px] flex items-center justify-center p-4">
      <div className="max-w-4xl w-full space-y-4">
        <div className="text-center mb-4">
          <h2 className="text-2xl font-bold text-slate-900">¿Qué tipo de registro deseas hacer?</h2>
          <p className="text-slate-600 text-sm">Elige la opción que corresponda a tu situación</p>
        </div>

        <Alert className="bg-gradient-to-r from-cyan-50 to-blue-50 border-2 border-cyan-400">
          <UserPlus className="h-5 w-5 text-cyan-700" />
          <AlertDescription className="text-cyan-900">
            <p className="font-bold text-sm mb-1">👥 ¿Tu pareja ya ha dado de alta a vuestro/a hijo/a?</p>
            <p className="text-xs">
              <strong>NO des de alta al jugador otra vez.</strong> Tu pareja debe añadirte como "segundo progenitor" desde la ficha del jugador.
            </p>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-6 border-4 border-orange-300">
            <div className="text-center space-y-3">
              <div className="w-16 h-16 bg-orange-500 rounded-full flex items-center justify-center mx-auto">
                <Users className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-orange-900">👨‍👩‍👧 Panel de Familia</h3>
              <p className="text-sm text-orange-800">Soy el <strong>primer progenitor</strong> que da de alta al jugador</p>
              <div className="bg-white rounded-lg p-3 border border-orange-200 text-left text-xs space-y-1">
                <p>✅ Inscribir hijos menores de 18</p>
                <p>✅ Tu pareja aún no ha dado de alta al jugador</p>
                <p>✅ Después invitar al segundo progenitor</p>
              </div>
              <Button className="w-full bg-orange-600 text-white font-bold py-4" disabled>
                Soy el primer progenitor →
              </Button>
            </div>
          </div>

          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 border-4 border-green-300">
            <div className="text-center space-y-3">
              <div className="w-16 h-16 bg-green-600 rounded-full flex items-center justify-center mx-auto">
                <UserCircle className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-green-900">👤 Panel de Jugador +18</h3>
              <p className="text-sm text-green-800">Jugadores mayores de edad que se inscriben a sí mismos</p>
              <div className="bg-white rounded-lg p-3 border border-green-200 text-left text-xs space-y-1">
                <p>✅ Mayor de 18 años</p>
                <p>✅ Panel simplificado con tus convocatorias y pagos</p>
                <p>✅ No necesitas gestionar menores</p>
              </div>
              <Button className="w-full bg-green-600 text-white font-bold py-4" disabled>
