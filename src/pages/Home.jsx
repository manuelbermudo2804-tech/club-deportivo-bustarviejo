...
import { Users, CreditCard, ShoppingBag, Calendar, Megaphone, Image, Clock, MessageCircle, Bell, Settings, ClipboardCheck, CheckCircle2 } from "lucide-react";
...
export default function Home() {
  ...
  const buildMenuItems = () => {
    ...
    // Add Plantillas and Asistencia for COACHES
    if (isCoach) {
      items.push(
        {
          title: "🎓 Plantillas",
