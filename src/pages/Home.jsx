        ...
        {isAdmin && (
          <div className="space-y-8">
            ...
            <div className="space-y-3">
              <h3 className="text-xl font-bold text-white px-2">💰 Finanzas</h3>
            ...
            {/* DEPORTIVO */}
            <div className="space-y-3">
              <h3 className="text-xl font-bold text-white px-2">⚽ Deportivo</h3>
              <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-3 lg:gap-4">
            ...
            {/* GESTIÓN DE PERSONAS */}
            <div className="space-y-3">
              <h3 className="text-xl font-bold text-white px-2">👥 Gestión de Personas</h3>
              <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-3 lg:gap-4">
            ...
            {/* COMUNICACIÓN */}
            <div className="space-y-3">
              <h3 className="text-xl font-bold text-white px-2">💬 Comunicación</h3>
              <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-3 lg:gap-4">
            ...
            {/* TIENDA Y SERVICIOS */}
            <div className="space-y-3">
              <h3 className="text-xl font-bold text-white px-2">🛍️ Tienda y Servicios</h3>
              <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-3 lg:gap-4">
            ...
            {/* CONFIGURACIÓN */}
            <div className="space-y-3">
              <h3 className="text-xl font-bold text-white px-2">⚙️ Configuración</h3>
              <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-3 lg:gap-4">
