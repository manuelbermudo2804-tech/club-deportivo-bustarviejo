...
export default function ParentLottery() {
  ...
  const [metodoPago, setMetodoPago] = useState("Entrenador");
  ...
  const handleSubmit = (e) => {
    ...
    if (requierePagoAdelantado && metodoPago !== "Entrenador" && !justificanteUrl) {
...
{/* Sección de Pago */}
                ...
                <div className="flex gap-3">
                  ...
                  <Button 
                    ...
                    disabled={createOrderMutation.isPending || (requierePagoAdelantado && metodoPago !== "Entrenador" && !justificanteUrl)}
                  >
