...
import { CheckCircle2, Trophy, Mail, ArrowRight, Loader2, Sparkles } from "lucide-react";
              ...
              <>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="text-slate-700">
                        A <strong>{participante.email}</strong> con tu enlace mágico de acceso. Si no lo ves, revisa <strong>spam o promociones</strong>.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="text-center pt-2">
                  ...
                  <p className="text-xs text-slate-500">
                    💡 Cuando termines tus predicciones podrás guardar tu enlace personal
                  </p>
                </div>
              </>
            )}
