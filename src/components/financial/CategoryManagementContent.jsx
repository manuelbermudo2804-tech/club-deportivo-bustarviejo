    ...
    <div className="space-y-6">
      ...
      <Alert className="bg-blue-50 border-blue-200">
        ...
        <AlertDescription className="text-blue-800 ml-2">
          <strong>ℹ️ ¿Qué son las categorías?</strong>
          <p className="mt-1 text-sm">
            Las categorías son los grupos de jugadores (Pre-Benjamín, Benjamín, etc.). 
            Todas usan las <strong>cuotas configuradas en la pestaña "Temporadas"</strong>.
            Aquí puedes ver cuántos jugadores hay en cada categoría o crear categorías personalizadas si lo necesitas.
          </p>
        </AlertDescription>
      </Alert>
