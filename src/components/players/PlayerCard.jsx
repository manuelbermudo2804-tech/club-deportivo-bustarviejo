              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  ...
                  {!confirmingRenew ? (
                    ...
                    <div className="bg-orange-100 border-2 border-orange-400 rounded-lg p-2 space-y-2">
                      <p className="text-xs text-orange-900 font-bold">✅ Confirmar renovación:</p>
                      <p className="text-xs text-orange-800">Categoría: <strong>{selectedCategory || player.deporte}</strong></p>
                      <div className="flex gap-2">
                        <Button
                          size="sm"
                          onClick={(e) => {
