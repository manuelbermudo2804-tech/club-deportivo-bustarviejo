            ...
            <div className="bg-gradient-to-r from-orange-50 to-orange-100 border-2 border-orange-400 rounded-lg p-3 space-y-2">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-orange-800 leading-relaxed mb-2">
                    Es momento de renovar la inscripción de {player.nombre} para la próxima temporada
                  </p>
                  <div className="space-y-2">
                    {onRenew && (
                      <Button
              ...
              {showCategoryModal && (
                <div className="bg-white border-2 border-orange-300 rounded-lg p-3 space-y-2 mt-2">
                  <label className="text-xs font-semibold text-slate-900">Elige categoría:</label>
                  <select 
