...
const TOOLS = [
  ...
  { key: "ver_convocatorias", emoji: "📋", titulo: "Convocatorias", subtitulo: "Solo lectura", href: () => "/MinorCoachCallups", color: "from-green-600 to-emerald-700" },
      ...
      <Card className="border-none shadow-lg bg-gradient-to-r from-amber-50 to-orange-50">
        <CardContent className="p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-bold text-amber-900 text-sm">🧢 Entrenador en prácticas</p>
