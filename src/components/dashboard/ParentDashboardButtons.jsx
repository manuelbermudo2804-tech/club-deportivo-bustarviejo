...
export const ALL_PARENT_BUTTONS = [
  ...
  { id: "tienda", title: "🛍️ Tienda y Equipaciones", icon: ShoppingBag, url: createPageUrl("Tienda"), gradient: "from-orange-600 to-orange-700", priority: 16, competitionOnly: true },
