...
export const ALL_COACH_BUTTONS = [
  ...
  { id: "calendario", title: "📅 Agenda del club", icon: Calendar, url: "/AgendaClub", gradient: "from-purple-600 to-purple-700", priority: 10, section: "club" },
  { id: "voluntariado", title: "🤝 Voluntariado y Comunidad", icon: Users, url: createPageUrl("Voluntariado"), gradient: "from-teal-600 to-teal-700", priority: 11, section: "club" },
