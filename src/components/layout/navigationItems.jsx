...
export function buildAdminNavigation(ctx) {
  ...
  return [
    ...
    { title: "🛍️ Tienda y Equipaciones", url: createPageUrl("Tienda"), icon: ShoppingBag },
...
export function buildParentNavigation(ctx) {
  ...
  const items = [
    ...
    { title: "📢 Anuncios", url: createPageUrl("Announcements"), icon: Megaphone },
    { title: "📄 Documentos y LOPIVI", url: createPageUrl("ParentDocuments"), icon: FileText },
    ...(!onlyComplementary ? [{ title: "🛍️ Tienda y Equipaciones", url: createPageUrl("Tienda"), icon: ShoppingBag }] : []),
