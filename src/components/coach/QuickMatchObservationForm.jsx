            ...
            <>
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <div>
                  ...
                  <Input type="number" value={formData.jornada} onChange={(e) => markDirty({ ...formData, jornada: e.target.value })} placeholder="5" className="h-9 bg-slate-100" disabled={!!jornada} />
                </div>
                <div>
            ...
            <>
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <Input type="number" min="0" value={formData.goles_primera_parte} onChange={(e) => markDirty({ ...formData, goles_primera_parte: e.target.value })} placeholder="0" className="h-9" />
                </div>
                <div>
                  <Label className="text-xs">Goles 2ª Parte</Label>
                  <Input type="number" min="0" value={formData.goles_segunda_parte} onChange={(e) => markDirty({ ...formData, goles_segunda_parte: e.target.value })} placeholder="0" className="h-9" />
                </div>
              </div>
              <div>
