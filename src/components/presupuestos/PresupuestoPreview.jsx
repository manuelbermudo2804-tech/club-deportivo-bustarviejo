    ...
    >
      ...
      <div className="relative p-6 h-full flex flex-col">
        <div className="flex items-start justify-between gap-3 mb-4">
          ...
          <div className="bg-blue-50 border border-blue-500 rounded-md px-3 py-2 text-right flex-shrink-0">
            <p className="text-[9px] font-bold text-slate-900 tracking-wider">PRESUPUESTO</p>
            <p className="text-[8px] text-slate-500 mt-1">Nº</p>
            <p className="text-base font-black text-blue-600 leading-tight">{numero || "—"}</p>
            <div className="mt-1 text-[8px] text-slate-600">
              <p>Fecha: <span className="font-bold text-slate-900">{fechaFmt || "—"}</span></p>
              {fechaValFmt && <p>Válido: <span className="font-bold text-slate-900">{fechaValFmt}</span></p>}
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-md p-2.5 mb-3 relative overflow-hidden">
          ...
          <p className="text-[8px] font-bold text-blue-600 tracking-wider ml-1">DIRIGIDO A</p>
        ...
        <div className="ml-auto w-1/2 mb-3">
          ...
          <div className="flex justify-between items-center bg-blue-600 text-white rounded-md px-2 py-1.5 mt-1">
        ...
        <div className="grid grid-cols-2 gap-2 mb-2 text-[8.5px]">
          {(formaPago || iban) && (
            <div className="bg-blue-50 border border-blue-300 rounded-md p-1.5">
              <p className="text-[7.5px] font-bold text-blue-600 tracking-wider">FORMA DE PAGO</p>
        ...
        {fechaValFmt && (
          <div className="text-center text-[7.5px] text-slate-500 italic mb-1">
        ...
        <div className="mt-auto flex items-end justify-between gap-2 pb-2">
          ...
          <div className="text-center relative flex-shrink-0">
            ...
            <div className="w-44 border-t-2 border-slate-700 pt-0.5">
              <p className="text-[7.5px] font-bold text-blue-600 tracking-wider">EL PRESIDENTE</p>
