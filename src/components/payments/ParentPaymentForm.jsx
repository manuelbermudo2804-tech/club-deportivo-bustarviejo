...
import { CUOTAS_FALLBACK, CATEGORY_NAME_MAPPING, FECHAS_VENCIMIENTO, getCuotasFromConfig, getImportePorMesFromConfig, getTotalConDescuentoFromConfig } from '../../lib/cuotasConfig';
