...
const ONBOARDING_STEPS = [
  {
    ...
    description: "Como entrenador tienes herramientas para gestionar tu equipo. Esta guía te ayudará a conocer las funciones principales.",
    icon: "🏃",
  },
  {
    id: 2,
    title: "Tu Plantilla ⚽",
    description: "En 'Plantillas' puedes ver todos los jugadores de tus categorías asignadas con su información y contactos.",
    icon: "👨‍👩‍👧",
  },
  {
    id: 3,
    title: "Convocatorias 🏆",
    description: "Crea convocatorias para partidos en 'Convocatorias'. Los padres recibirán notificación y podrán confirmar asistencia.",
    icon: "📋",
  },
  {
    id: 4,
    title: "Asistencia y Evaluaciones 📊",
    description: "Registra la asistencia a entrenamientos y evalúa el progreso de cada jugador en 'Asistencia y Evaluación'.",
    icon: "⭐",
  },
  {
    id: 5,
    title: "Chat con Familias 💬",
    description: "Comunícate con los padres de tu equipo a través de 'Chat Equipos'. Pueden enviarte mensajes y consultas.",
    icon: "📱",
  },
  {
    id: 6,
    title: "¡Todo listo! 🎊",
    description: "Ya conoces lo básico. Explora el calendario, la galería y los anuncios. ¡Mucha suerte esta temporada!",
    icon: "✅",
  },
];
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6 text-white relative">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm">CD Bustarviejo</p>
              </div>
            </div>
