                ...
                <div className="p-6 lg:p-10 pt-12">
                  <div className="flex items-center justify-between flex-wrap gap-4 mb-6">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-purple-300 text-xs">+ 100€ cuota base = <strong className="text-white">600€ total</strong></p>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-400/30 rounded-xl p-4 mb-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
                      ...
                      <div>
                        <p className="text-2xl font-black text-white">Gran</p>
                        <p className="text-[10px] text-purple-200 uppercase tracking-wide">comunidad en redes</p>
                      </div>
                      <div>
                        <p className="text-2xl font-black text-white">Web</p>
                        <p className="text-[10px] text-purple-200 uppercase tracking-wide">abierta al pueblo y la sierra</p>
                      </div>
                      <div>
