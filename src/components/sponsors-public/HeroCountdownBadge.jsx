...
export default function HeroCountdownBadge({ deadline }) {
  ...
  // Plazo finalizado → no mostramos nada para no transmitir que el patrocinio está cerrado.
  // Las opciones activas (torneos y pancarta del campo) siguen disponibles.
