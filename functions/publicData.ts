...
<div class="tabs">
  <button class="tab activo" onclick="mostrar('proximos')">📅 Próximos</button>
  <button class="tab" onclick="mostrar('clasificacion')">🏆 Clasificación</button>
  <button class="tab" onclick="mostrar('goleadores')">⚽ Goleadores</button>
</div>
